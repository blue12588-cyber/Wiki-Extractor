...
const SYNONYMS: Record<string, string[]> = {
  ...
  cor: ['corinthians', '코린', '코린토', '고린토', '고린', '1코린', '2코린'],
  corinthians: ['cor', '코린', '코린토', '고린토', '고린', '1코린', '2코린'],
  gal: ['galatians', '갈라', '갈라티아'],
  galatians: ['gal', '갈라', '갈라티아'],
  acts: ['사도', '사도행전'],
  heb: ['hebrews', '히브', '히브리'],
  hebrews: ['heb', '히브', '히브리'],
  john: ['요한'],
  ...
  코린: ['cor', 'corinthians', '1코린', '2코린'],
  코린토: ['cor', 'corinthians', '고린토', '1코린', '2코린'],
  고린토: ['cor', 'corinthians', '코린토', '1코린', '2코린'],
  고린: ['cor', 'corinthians', '코린', '1코린', '2코린'],
  '1코린': ['cor', 'corinthians', '코린', '코린토', '고린토', '고린'],
  '2코린': ['cor', 'corinthians', '코린', '코린토', '고린토', '고린'],
  갈라: ['gal', 'galatians', '갈라티아'],
  갈라티아: ['gal', 'galatians', '갈라'],
  사도: ['acts', '사도행전'],
  사도행전: ['acts', '사도'],
  히브: ['heb', 'hebrews', '히브리'],
  히브리: ['heb', 'hebrews', '히브'],
