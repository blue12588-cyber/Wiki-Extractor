        ...
        <div class="step-text">
          ...
          {:else}
            ...
            <div class="branch" data-kind="auto">
              ...
              <p class="branch-note">
                브라우저가 자동으로 열리지 않는 환경(회사·학교 방화벽, 원격 접속 등)에서는
                같은 화면의 <strong>[브라우저가 안 열리면 · 코드 입력 방식으로 로그인]</strong>을
                누르세요. 화면에 주소와 짧은 코드가 뜨면, 다른 기기·브라우저에서 그 주소로
                들어가 코드를 입력해 로그인을 마칠 수 있습니다.
              </p>
